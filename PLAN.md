...
---
- **Gün HUD'u: zaman pastası + güneş/ay + kira satırı (2026-09-23):** UYGULANDI, kontrol ONAY, commit yok — kullanıcı Unity/Play kontrolü bekleniyor → `plans/gun-hud.md`
- **Tutorial bantlama masası + 2 adım (2026-09-21):** UYGULANDI, kontrol ONAY (2. tur), commit yok, playtest bekliyor → `plans/tutorial-bant-masasi.md`
