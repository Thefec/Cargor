...
- [ ] Adım 7 — playtest (2026-09-11 turunda 10 gerçek bug bulunup düzeltildi — bkz. `plans/devam.md`; kullanıcı playtest'e devam ediyor, henüz uçtan uca tamamlanmadı; headless doğrulama + kontrol kapısı playtest bitince)
