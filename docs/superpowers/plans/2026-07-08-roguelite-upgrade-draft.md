...
>
> **Cargor iş akışı notu:** Bu plan **gameplay** departmanı tarafından uygulanır. Her task çıktısı **qa** ve zorunlu **kontrol** (Fable 5) kapısından geçer. Ekonomik değer gereken her yerde değerler `UPGRADE_PRICING_REPORT.md` v3.2'den ALINIR — yeni değer uydurulmaz; sapma gerekiyorsa önce economist'e danışılır.
...
Tüm task'ların çıktısı **kontrol** (Fable 5) denetiminden ONAY alır. DÜZELTME GEREKLİ → ilgili task'a geri döner.
