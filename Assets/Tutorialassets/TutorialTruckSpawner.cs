...
{
    /// <summary>
    /// Tutorial i�in truck spawn sistemi. 
    /// Garaj kap�s� a��ld���nda truck'� spawn eder.
    /// </summary>
    public class TutorialTruckSpawner : NetworkBehaviour
    {
        ...
        [Header("=== TRUCK PREFAB ===")]
        [SerializeField, Tooltip("Tutorial truck prefab'�")]
        ...
        [SerializeField, Tooltip("�stenen kutu t�r�")]
        private BoxInfo.BoxType requestedBoxType = BoxInfo.BoxType.Red;

        [SerializeField, Tooltip("Gerekli kargo say�s�")]
        ...
        [Header("=== REFERENCES ===")]
        [SerializeField, Tooltip("Garaj kap�s� referans�")]
        ...
        private void SpawnTruckInternal()
        {
            ...
            // Spawn rotasyonu - D�ZELTME BURADA
            ...
            // TutorialTruck component'ini al ve yap�land�r
        ...
        private void NotifyTruckSpawnedClientRpc(ulong networkObjectId)
        {
            ...
            // Client'ta truck referans�n� bul
        ...
        /// <summary>
        /// Spawner'� s�f�rlar (yeni tutorial i�in)
        /// </summary>
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            // Spawn pozisyonunu g�ster
            Gizmos.color = Color.green;
            Gizmos.DrawWireSphere(spawnPos, 0.5f);

            // Hesaplanan rotasyonu g�ster
            Quaternion finalRotation = CalculateSpawnRotation();

            // Forward y�n� (truck'�n gidece�i y�n)
            ...
            // Truck'�n yakla��k boyutunu g�ster
            Gizmos.color = new Color(1f, 1f, 0f, 0.3f);
            Matrix4x4 rotationMatrix = Matrix4x4.TRS(spawnPos, finalRotation, Vector3.one);
            Gizmos.matrix = rotationMatrix;
            Gizmos.DrawWireCube(Vector3.zero, new Vector3(2f, 2f, 5f)); // Yakla��k truck boyutu
