...
{
    /// <summary>
    /// C tuşuna basılı tutunca belirtilen TMP elementlerini gösterir. 
    /// Tuş bırakıldığında gizler.  Inspector'dan TMP listesi yönetilebilir.
    /// </summary>
    public class TMPRevealSystem : MonoBehaviour
    {
        ...
        [SerializeField, Tooltip("Smooth geçiş kullan")]
        private bool useFadeTransition = true;

        [SerializeField, Range(1f, 20f), Tooltip("Fade geçiş hızı")]
        private float fadeSpeed = 10f;

        [Header("=== OPTIONAL SETTINGS ===")]
        [SerializeField, Tooltip("Oyun başladığında TMP'leri gizle")]
        private bool hideOnStart = true;

        [SerializeField, Tooltip("Canvas Group kullan (tüm child'ları etkiler)")]
        ...
        // Her TMP için orijinal alpha değerlerini sakla
        ...
        {
            // Orijinal alpha değerlerini kaydet
        ...
        {
            // C tuşuna basılı tutulduğunda göster
        ...
        {
            // Editor'da null elemanları temizle
